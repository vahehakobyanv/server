  ...
  if (mi->host[0])
  {
    ...
    */
    ...
    if (full)
    {
      ...
      protocol->store((ulonglong) mi->rli.statement_timeouts);
  ...
  */
  ...
  else
  {
    ...
    */
    ...
    /*
      Application of this event timed out. Report this and reset thd killed
      status because it is a replication thread that will execute more
      commands.
    */
    if (thd->get_stmt_da()->is_error() &&
